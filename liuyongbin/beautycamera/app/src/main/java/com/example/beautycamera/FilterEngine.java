...
public class FilterEngine {
    ...
    public FilterEngine(int OESTextureId, Context context, int type) {
        ...
        switch (type) {
            case 0:
                fragmentShader = loadShader(GL_FRAGMENT_SHADER, Utils.readShaderFromResource(mContext, R.raw.base_fragment_shader_texure));
                break;
            case 1:
                fragmentShader = loadShader(GL_FRAGMENT_SHADER, Utils.readShaderFromResource(mContext, R.raw.base_fragment_shader_bw));
                break;
            case 2:
                fragmentShader = loadShader(GL_FRAGMENT_SHADER, Utils.readShaderFromResource(mContext, R.raw.base_fragment_shader_relief));
                break;
            case 3:
                fragmentShader = loadShader(GL_FRAGMENT_SHADER, Utils.readShaderFromResource(mContext, R.raw.base_fragment_shader_split));
                break;
            case 4:
                fragmentShader = loadShader(GL_FRAGMENT_SHADER, Utils.readShaderFromResource(mContext, R.raw.base_fragment_shader_mosaic));
                break;
            case 5:
                fragmentShader = loadShader(GL_FRAGMENT_SHADER, Utils.readShaderFromResource(mContext, R.raw.base_fragment_shader_sw));
                break;
            case 6:
                fragmentShader = loadShader(GL_FRAGMENT_SHADER, Utils.readShaderFromResource(mContext, R.raw.base_fragment_shader_sg));
                break;
            default:
                break;
        }
    ...
    public static final String BETALEVEL = "betalevel";
    public static final String AlphaLevel = "alphaLevel";
