...
void main() {
	const float scaleFactor=1.0/100.0;//给出最终求和时的加权因子(调整亮度)
	//卷积内核中各个位置的值
	float kernelValue0 = 9.5; float kernelValue1 = 11.8; float kernelValue2 = 9.5;
	float kernelValue3 = 11.8; float kernelValue4 = 14.8; float kernelValue5 = 11.8;
	float kernelValue6 = 9.5; float kernelValue7 = 11.8; float kernelValue8 = 9.5;
	vec4 sum;//最终的颜色和
	//获取卷积内核中各个元素对应像素的颜色值
