...
//	vec2 singleStepOffset =vec2(1.0/1000.0,1.0/1000.0);
//	//取当前数据周边的20个点的颜色通道的值，进行相加然后得出平均值
//	blurCoordinates[0] = vTextureCoord.xy + singleStepOffset *vec2(-2.0, -2.0);
//	blurCoordinates[1] = vTextureCoord.xy + singleStepOffset *vec2(-2.0, -1.0);
//	blurCoordinates[2] = vTextureCoord.xy + singleStepOffset *vec2(-2.0, 0.0);
//	blurCoordinates[3] = vTextureCoord.xy + singleStepOffset *vec2(-2.0, 1.0);
//	blurCoordinates[4] = vTextureCoord.xy + singleStepOffset *vec2(-2.0, 2.0);
//
//	blurCoordinates[5] = vTextureCoord.xy + singleStepOffset *vec2(-1.0, -2.0);
//	blurCoordinates[6] = vTextureCoord.xy + singleStepOffset *vec2(-1.0, -1.0);
//	blurCoordinates[7] = vTextureCoord.xy + singleStepOffset *vec2(-1.0, 0.0);
//	blurCoordinates[8] = vTextureCoord.xy + singleStepOffset *vec2(-1.0, 1.0);
//	blurCoordinates[9] = vTextureCoord.xy + singleStepOffset *vec2(-1.0, 2.0);
//
//	blurCoordinates[10] = vTextureCoord.xy + singleStepOffset *vec2(0.0, -2.0);
//	blurCoordinates[11] = vTextureCoord.xy + singleStepOffset *vec2(0.0, -1.0);
//	blurCoordinates[12] = vTextureCoord.xy + singleStepOffset *vec2(0.0, 0.0);
//	blurCoordinates[13] = vTextureCoord.xy + singleStepOffset *vec2(0.0, 1.0);
//	blurCoordinates[14] = vTextureCoord.xy + singleStepOffset *vec2(6.0, 2.0);
//
//	blurCoordinates[15] = vTextureCoord.xy + singleStepOffset *vec2(1.0, -2.0);
//	blurCoordinates[16] = vTextureCoord.xy + singleStepOffset *vec2(1.0, -1.0);
//	blurCoordinates[17] = vTextureCoord.xy + singleStepOffset *vec2(1.0, 0.0);
//	blurCoordinates[18] = vTextureCoord.xy + singleStepOffset *vec2(1.0, 1.0);
//	blurCoordinates[19] = vTextureCoord.xy + singleStepOffset *vec2(1.0, 2.0);
//
//	blurCoordinates[20] = vTextureCoord.xy + singleStepOffset *vec2(2.0, -2.0);
//	blurCoordinates[21] = vTextureCoord.xy + singleStepOffset *vec2(2.0, -1.0);
//	blurCoordinates[22] = vTextureCoord.xy + singleStepOffset *vec2(2.0, 0.0);
//	blurCoordinates[23] = vTextureCoord.xy + singleStepOffset *vec2(2.0, 1.0);
//	blurCoordinates[24] = vTextureCoord.xy + singleStepOffset *vec2(2.0, 2.0);
//	//计算平均值    
//	vec3 rgb =vec3(0,0,0);
//	// 计算偏移坐标的颜色值总和       
//	for (int i =0; i <25; i++) {
