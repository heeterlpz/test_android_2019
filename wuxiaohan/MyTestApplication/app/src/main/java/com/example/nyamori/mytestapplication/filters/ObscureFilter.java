...
public class ObscureFilter extends BaseFilter {
    private float[] mKernel = new float[ShaderInfo.KERNEL_SIZE];
    private float[] mTexOffset;
    private int muKernelLoc;
    private int muTexOffsetLoc;

    public ObscureFilter(int width,int height){
        super();
    ...
    public void getLocation() {
        ...
        setKernel(new float[] {0.05f, 0.1f, 0.05f,  0.1f, 0.4f, 0.1f,  0.05f, 0.1f, 0.05f});
        setTexSize(256, 256);
    }
